defmodule Events.ResponsesTest do
  ...
  describe "responses" do
    ...
    @valid_attrs %{email: "some email", rsp: "some rsp"}
    @update_attrs %{email: "some updated email", rsp: "some updated rsp"}
    @invalid_attrs %{email: nil, rsp: nil}
    ...
    test "update_response/2 with valid data updates the response" do
      ...
      assert response.rsp == "some updated rsp"
    end
